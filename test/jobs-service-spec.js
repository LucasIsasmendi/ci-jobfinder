...
describe("save jobs", function(){
	...
	var newJob = {title:'Developer', description:'MEAN.js DevOps with AWS skills'};
	...
	it("should return s status of 200 to the front end if database saved");
	it("should return a job an id");
